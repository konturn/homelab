docker run --rm -e "NAMESILO_API_KEY=$1" -e "NAMESILO_PROPAGATION_TIMEOUT=100000" --network docker_internal -v {{ docker_persistent_data_path }}/certs/nkontur.com:/ssl goacme/lego --dns namesilo --domains *.nkontur.com --domains nkontur.com --domains *.lab.nkontur.com --domains *.iot.lab.nkontur.com --domains *.zwave.lab.nkontur.com --domains *.satellite-2.lab.nkontur.com --domains *.satellite-3.lab.nkontur.com --domains *.satellite-4.lab.nkontur.com --domains *.fallback.lab.nkontur.com --email konoahko@gmail.com --dns.resolvers 1.1.1.1 --path /ssl -a run
